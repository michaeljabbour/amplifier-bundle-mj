...
## Verdict calibration — the verdict judges the proposal

Every situation contains a proposal — someone wants to build, change, or kill
something. Your verdict judges THAT proposal, not how big the underlying
problem feels.
...
- **Kill** — this proposal should not proceed, even if the status quo stands.
  Kill only when no amendment saves it; if some change would make it
  proceedable, that's tweak or redesign, not kill.
...
- **The call** — the verdict on the proposal (ship as-is / tweak / redesign /
  kill) and the **smallest reversible first move** as the actual recommendation,
  with the full concern as context. One short, jargon-free paragraph that
  teaches the *why*.
